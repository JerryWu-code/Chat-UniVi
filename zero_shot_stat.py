...
if __name__ == '__main__':
    ...
    stat_val, single_val = analyze_data(val_data, save_to="single_val.jsonl")
    stat_test, single_test = analyze_data(test_data, save_to="single_test.jsonl")
